...
(function (Textor) {
  var ContainerUndoUnit = /** @class */ (function () {
    ...
    Object.defineProperty(ContainerUndoUnit.prototype, "isEmpty", {
      get: function () {
        return (
          this._undoUnits.length > 0 &&
          this._undoUnits.every(function (undoUnit) {
            return undoUnit.isEmpty;
          })
        );
      },
      enumerable: true,
  ...
  var LanguageService = /** @class */ (function () {
    ...
    LanguageService.prototype.invalidate = function (oldRange, newRange, text) {
      if (this._language !== null) {
        ...
        if (this._syntaxTable.length > 0) {
          ...
          var index = 0;
          while (
            this._syntaxTable[line] &&
            index < this._syntaxTable[line].length &&
            oldRange.start.column > this._syntaxTable[line][index].start
          ) {
            index++;
          }
          while (line >= 0 && index >= 0) {
            ...
            if (index < 0) {
              line--;
              index = this._syntaxTable[line]
                ? this._syntaxTable[line].length - 1
                : 0;
            }
            if (
              this._syntaxTable[line] &&
              this._syntaxTable[line][index] &&
              this._syntaxTable[line][index].state !== null
            ) {
        ...
        this._index = 0;
        while (
          this._syntaxTable[this._line] &&
          this._index < this._syntaxTable[this._line].length &&
          this._column > this._syntaxTable[this._line][this._index].start
        ) {
          this._index++;
        }
    ...
    LanguageService.prototype.window_setTimeout = function () {
      ...
      if (this._textReader.peek().length > 0) {
        this._timeout = window.setTimeout(
          this.window_setTimeout.bind(this),
          100
        );
      ...
      this._textEditor.invalidateRange(
        new Textor.TextRange(
          startPosition,
          new Textor.TextPosition(this._line, this._column)
        )
      );
    ...
    LanguageService.prototype.moveRange = function (oldPosition, newPosition) {
      if (oldPosition.compareTo(newPosition) < 0) {
        ...
        var index = 0;
        while (
          this._syntaxTable[oldPosition.line] &&
          index < this._syntaxTable[oldPosition.line].length &&
          oldPosition.column > this._syntaxTable[oldPosition.line][index].start
        ) {
          index++;
        }
        if (this._syntaxTable[oldPosition.line]) {
          var syntax = this._syntaxTable[oldPosition.line].splice(
            index,
            this._syntaxTable[oldPosition.line].length - index
          );
          ...
          if (size > 0) {
              ...
              newArray[i] =
                index > 0
                  ? [
                      {
                        style:
                          this._syntaxTable[oldPosition.line][index - 1].style,
                        state: null,
                        start: 0,
                      },
                    ]
            ...
            var tail = this._syntaxTable.splice(
              oldPosition.line + 1,
              this._syntaxTable.length - oldPosition.line + 1
            );
            this._syntaxTable = this._syntaxTable.concat(newArray, tail);
          }
          this._syntaxTable[newPosition.line] =
            this._syntaxTable[newPosition.line].concat(syntax);
        }
        ...
        if (oldPosition.line >= this._syntaxTable.length) {
          ...
          while (
            ...
            index < this._syntaxTable[oldPosition.line].length &&
            oldPosition.column >
              this._syntaxTable[oldPosition.line][index].start
          ) {
            index++;
          }
        }
        if (this._syntaxTable[oldPosition.line]) {
          ...
          while (
            this._syntaxTable[newPosition.line] &&
            index < this._syntaxTable[newPosition.line].length &&
            newPosition.column >
              this._syntaxTable[newPosition.line][index].start
          ) {
            index++;
          }
          this._syntaxTable.splice(
            newPosition.line + 1,
            oldPosition.line - newPosition.line
          );
          this._syntaxTable[newPosition.line].splice(
            index,
            this._syntaxTable[newPosition.line].length - index
          );
          this._syntaxTable[newPosition.line] =
            this._syntaxTable[newPosition.line].concat(syntax);
        }
    ...
    LanguageService.prototype.clearRange = function (
      startPosition,
      endPosition
    ) {
      if (startPosition.line === endPosition.line) {
        ...
        if (line) {
          ...
          for (var i = 0; i < line.length; i++) {
            ...
            if (startIndex !== -1 && endPosition.column >= line[i].start) {
              this._syntaxTable[startPosition.line].splice(
                startIndex,
                i - startIndex
              );
              break;
        ...
        if (this._syntaxTable[startPosition.line]) {
          for (
            var i = this._syntaxTable[startPosition.line].length - 1;
            i >= 0;
            i--
          ) {
            if (
              this._syntaxTable[startPosition.line][i].start >
        ...
        if (this._syntaxTable[endPosition.line]) {
          for (
            var i = this._syntaxTable[endPosition.line].length - 1;
            i >= 0;
            i--
          ) {
            if (
              this._syntaxTable[endPosition.line][i].start < endPosition.column
            ) {
    ...
    LanguageService.prototype.addRecord = function (
      column,
      nextLine,
      style,
      state
      ...
      if (
        this._index > 0 &&
        this._index - 1 < this._syntaxTable[this._line].length &&
        this._syntaxTable[this._line][this._index - 1].start === this._column
      ) {
        ...
        if (column >= current.start) {
          ...
          this._syntaxTable[this._line].splice(
            this._index,
            0,
            new Textor.LanguageStyle(style, state, column)
          );
          this._index++;
        }
      } else {
        this._syntaxTable[this._line].push(
          new Textor.LanguageStyle(style, state, column)
        );
        this._index++;
      }
      while (this._line < nextLine) {
        this._syntaxTable[this._line].splice(
          this._index,
          this._syntaxTable[this._line].length - this._index
        );
        this._line++;
        this._index = 0;
...
(function (Textor) {
  var SelectionUndoUnit = /** @class */ (function () {
    ...
    SelectionUndoUnit.prototype.toString = function () {
      return (
        "Selection: " +
        this._redoTextRange.toString() +
        " => " +
        this._undoTextRange.toString()
      );
    };
...
(function (Textor) {
  var TextBuffer = /** @class */ (function () {
    ...
    TextBuffer.prototype.removeEventListener = function (type, callback) {
      switch (type) {
        case "textchanging":
          this._textChangingHandlers = this._textChangingHandlers.filter(
            function (item) {
          ...
          break;
        case "textchanged":
          this._textChangedHandlers = this._textChangedHandlers.filter(
            function (item) {
              return item !== callback;
            }
          );
    ...
    TextBuffer.prototype.setText = function (textRange, text) {
      ...
      var newRange = new Textor.TextRange(
        textRange.start.clone(),
        new Textor.TextPosition(
          textRange.start.line + lastLine,
          (lines.length === 1 ? textRange.start.column : 0) +
            lines[lastLine].length
        )
      );
      lines[0] =
        this._lines[textRange.start.line].substring(0, textRange.start.column) +
        lines[0];
      lines[lastLine] =
        lines[lastLine] +
        this._lines[textRange.end.line].substring(textRange.end.column);
      this.onTextChanging(
        new Textor.TextChangeEvent(textRange, newRange, text)
      );
      this._lines = this._lines
        .slice(0, textRange.start.line)
        .concat(lines, this._lines.slice(textRange.end.line + 1));
    ...
    TextBuffer.prototype.getText = function (textRange) {
      if (textRange.start.line !== textRange.end.line) {
        var lines = [];
        lines.push(
          this._lines[textRange.start.line].substring(textRange.start.column)
        );
        lines = lines.concat(
          this._lines.slice(textRange.start.line + 1, textRange.end.line)
        );
        lines.push(
          this._lines[textRange.end.line].substring(0, textRange.end.column)
        );
        return lines.join("\n");
      }
      return this._lines[textRange.start.line].substring(
        textRange.start.column,
        textRange.end.column
      );
    };
    TextBuffer.prototype.getTextRange = function () {
      return new Textor.TextRange(
        new Textor.TextPosition(0, 0),
        new Textor.TextPosition(
...
(function (Textor) {
  var TextController = /** @class */ (function () {
    function TextController(textEditor, canvas) {
      ...
      this._canvas = canvas;
      this._isWebKit =
        typeof navigator.userAgent.split("WebKit/")[1] !== "undefined";
      this._isChrome = navigator.userAgent.toLowerCase().indexOf("chrome") > -1;
      this._isMozilla =
        navigator.appVersion.indexOf("Gecko/") >= 0 ||
      ...
      this._canvas.addEventListener(
        "onmousewheel" in this._canvas ? "mousewheel" : "DOMMouseScroll",
        this._canvas_mouseWheelHandler,
        false
      );
      this._canvas.addEventListener(
        "touchstart",
        this._canvas_touchStartHandler,
        false
      );
      this._canvas.addEventListener(
        "touchmove",
        this._canvas_touchMoveHandler,
        false
      );
      this._canvas.addEventListener(
        "touchend",
        this._canvas_touchEndHandler,
        false
      );
      this._canvas.addEventListener(
        "mousedown",
        this._canvas_mouseDownHandler,
        false
      );
      window.addEventListener(
        "mousemove",
        this._window_mouseMoveHandler,
        false
      );
      window.addEventListener("mouseup", this._window_mouseUpHandler, false);
      this._textArea.addEventListener(
        "focus",
        this._textArea_focusHandler,
        false
      );
      this._textArea.addEventListener(
        "blur",
        this._textArea_blurHandler,
        false
      );
      this._textArea.addEventListener("cut", this._textArea_cutHandler, false);
      this._textArea.addEventListener(
        "copy",
        this._textArea_copyHandler,
        false
      );
      this._textArea.addEventListener(
        "paste",
      ...
      this._textArea.addEventListener(
        "beforecut",
        this._textArea_beforeCutHandler,
        false
      );
      this._textArea.addEventListener(
        "beforecopy",
        this._textArea_beforeCopyHandler,
        false
      );
      this._textArea.addEventListener(
        "keydown",
        this._textArea_keyDownHandler,
        false
      );
      this._textArea.addEventListener(
        "keypress",
        this._textArea_keyPressHandler,
        false
      );
      this._textArea.addEventListener(
        "keyup",
    ...
    TextController.prototype.isFocused = function () {
      return new RegExp("(^|\\s+)" + "focus" + "(\\s+|$)").test(
    ...
    TextController.prototype.textArea_blur = function (e) {
      if (this.isFocused()) {
        this._canvas.className = this._canvas.className.replace(
          new RegExp(" focus\\b"),
          ""
        );
      }
    ...
    TextController.prototype.textArea_keyPress = function (e) {
      if (this._isMozilla) {
        if (!this._keyCodeTable) {
          ...
          for (
            var _i = 0, _a = Object.keys(charCodeTable);
            _i < _a.length;
            _i++
          ) {
            var code = _a[_i];
            ...
            if (key.toUpperCase() !== key) {
              this._keyCodeTable[key.toUpperCase().charCodeAt(0)] = parseInt(
                code,
                10
              );
            }
        ...
        var keyCode =
          e.charCode !== 0 && this._keyCodeTable[e.charCode]
            ? this._keyCodeTable[e.charCode]
            : e.keyCode;
        if (
          this.processKey(keyCode, e.shiftKey, e.ctrlKey, e.altKey, e.metaKey)
        ) {
          this._textEditor.update();
          this.stopEvent(e);
          return;
    ...
    TextController.prototype.mouseScroll_interval = function () {
      ...
      if (
        textPosition.line < 0 ||
        textPosition.line >= size.line ||
        textPosition.column < 0 ||
        textPosition.column >= size.column
      ) {
        this.mouseScroll();
      }
    };
    ...
    TextController.prototype.startScrollTimer = function () {
      this.stopScrollTimer();
      this._scrollTimer = window.setInterval(
        this.mouseScroll_interval.bind(this),
        75
      );
    };
    ...
    TextController.prototype.updatePointerPosition = function (x, y) {
      ...
      this._pointerPosition = new Textor.Point(
        x * devicePixelRatio,
        y * devicePixelRatio
      );
      var node = this._canvas;
    ...
    TextController.prototype.processKey = function (
      keyCode,
      shiftKey,
      ctrlKey,
      altKey,
      ...
      return this._textEditor.processKey(
        keyCode,
        shiftKey,
        ctrlKey,
        altKey,
...
(function (Textor) {
  var TextEditor = /** @class */ (function () {
    function TextEditor(canvas) {
      ...
      this._textBuffer.addEventListener(
        "textchanging",
        this._textBuffer_textChanging
      );
      this._textBuffer.addEventListener(
        "textchanged",
        this._textBuffer_textChanged
      );
      this._textModel = new Textor.TextModel(
        this._undoService,
        this._textBuffer
      );
      this._textModel.addEventListener(
        "selectionchanged",
        this._textModel_selectionChanged
      );
    ...
    Object.defineProperty(TextEditor.prototype, "text", {
      ...
      set: function (value) {
        ...
        this._undoService.add(
          new Textor.TextUndoUnit(
            this._textModel,
            this._textBuffer,
            this._textBuffer.getTextRange(),
            value
          )
        );
        this._undoService.add(
          new Textor.SelectionUndoUnit(
            this._textModel,
            new Textor.TextRange(
              new Textor.TextPosition(0, 0),
              new Textor.TextPosition(0, 0)
    ...
    Object.defineProperty(TextEditor.prototype, "size", {
      get: function () {
        return this.getTextPosition(
          new Textor.Point(this._canvas.width, this._canvas.height)
        );
      },
      enumerable: true,
      configurable: true,
    ...
    TextEditor.prototype.dispose = function () {
      ...
      this._textBuffer.removeEventListener(
        "textchanging",
        this._textBuffer_textChanging
      );
      this._textBuffer.removeEventListener(
    ...
    TextEditor.prototype.removeEventListener = function (type, callback) {
      switch (type) {
        ...
        case "selectionchanged":
          this._selectionChangedHandlers =
            this._selectionChangedHandlers.filter(function (item) {
              return item !== callback;
            });
          break;
      }
    ...
    TextEditor.prototype.select = function (line, column) {
      ...
      var startPosition = this._textModel.toScreenPosition(
        this._textModel.toBufferPosition(textPosition)
      );
      var endPosition = this._textModel.toScreenPosition(
        this._textModel.toBufferPosition(textPosition)
      );
      this._undoService.begin();
      this._undoService.add(
        new Textor.SelectionUndoUnit(
          this._textModel,
          new Textor.TextRange(startPosition, endPosition)
        )
      );
      this._undoService.commit();
    ...
    TextEditor.prototype.selectRange = function (
      startLine,
      startColumn,
      endLine,
      endColumn
      ...
      this._undoService.add(
        new Textor.SelectionUndoUnit(
          this._textModel,
          new Textor.TextRange(
            new Textor.TextPosition(startLine, startColumn),
            new Textor.TextPosition(endLine, endColumn)
          )
        )
      );
      this._undoService.commit();
    ...
    TextEditor.prototype.selectTo = function (line, column) {
      ...
      textPosition = this._textModel.toScreenPosition(
        this._textModel.toBufferPosition(textPosition)
      );
      if (!this._textModel.textRange.end.equals(textPosition)) {
        ...
        this._undoService.add(
          new Textor.SelectionUndoUnit(
            this._textModel,
            new Textor.TextRange(
              this._textModel.textRange.start.clone(),
              textPosition
            )
          )
        );
    ...
    TextEditor.prototype.selectWord = function (line, column) {
      var textPosition = this._textModel.toBufferPosition(
        new Textor.TextPosition(line, column)
      );
      var text = this._textBuffer.getLine(textPosition.line);
      var startColumn = this._textModel.findWordBreak(
        text,
        textPosition.column + 1,
        -1
      );
      var endColumn = this._textModel.findWordBreak(
        text,
        textPosition.column,
        1
      );
      var textRange = new Textor.TextRange(
        new Textor.TextPosition(textPosition.line, startColumn),
        new Textor.TextPosition(textPosition.line, endColumn)
      );
      this._undoService.begin();
      this._undoService.add(
        new Textor.SelectionUndoUnit(
          this._textModel,
          this._textModel.toScreenRange(textRange)
        )
      );
      this._undoService.commit();
      this.update();
    ...
    TextEditor.prototype.scroll = function (vertical, horizontal) {
      ...
      var size = this.size;
      var maxLine =
        this._textBuffer.getLines() - size.line < 0
          ? 0
          : this._textBuffer.getLines() - size.line;
      var maxColumn =
        this.getMaxColumns() - size.column + 1 < 0
          ? 0
          : this.getMaxColumns() - size.column + 1;
    ...
    TextEditor.prototype.copy = function () {
      var textRange = this._textModel.toBufferRange(
        this._textModel.getTextRange()
      );
    ...
    TextEditor.prototype.processKey = function (
      keyCode,
      shiftKey,
      ctrlKey,
      altKey,
    ...
    TextEditor.prototype.updateScrollPosition = function () {
      ...
      var maxPosition = this._textModel.toScreenPosition(
        new Textor.TextPosition(
          selection.line,
          this._textBuffer.getColumns(selection.line)
        )
      );
      ...
      if (selection.column < 5) {
        ...
        if (
          this._scrollPosition.column + horizontal + size.column >
          maxColumns + 1
        ) {
          horizontal =
            maxColumns - size.column - this._scrollPosition.column + 1;
        }
      }
    ...
    TextEditor.prototype.invalidate = function () {
      this.invalidateRectangle(
        new Textor.Rectangle(0, 0, this._canvas.width, this._canvas.height)
      );
    };
    TextEditor.prototype.invalidateRange = function (textRange) {
      ...
      if (textRange.start.line === textRange.end.line) {
        ...
        this.invalidateRectangle(
          new Textor.Rectangle(x, y, width, fontSize.height)
        );
      } else {
        var height = (range.end.line - range.start.line + 1) * fontSize.height;
        this.invalidateRectangle(
          new Textor.Rectangle(x, y, this._canvas.width, height)
        );
      }
    };
    TextEditor.prototype.update = function () {
      if (this._invalidRectangles.length !== 0) {
        ...
        if (clipRectangle.width !== 0 && clipRectangle.height !== 0) {
          ...
          // erase background
          this._context.fillStyle = focused
            ? this._theme.backgroundColor
            : this._theme.backgroundBlurColor;
          ...
          if (this._textModel.isCursor()) {
            ...
            if (this._blinkState && this._textController.isFocused()) {
              ...
              this._context.fillRect(
                paddingLeft + selection.start.column * fontSize.width,
                y,
                1,
                fontSize.height
              );
            ...
            // draw selection
            this._context.fillStyle = focused
              ? this._theme.selectionColor
              : this._theme.selectionBlurColor;
            var y = 0;
              ...
              if (line === selection.start.line) {
                x =
                  selection.start.column < 0
                    ? 0
                    : selection.start.column * fontSize.width;
              }
          ...
          for (var i = 0; i < styles.length; i++) {
            ...
            this._context.font =
              themeProperties.length === 2 && themeProperties[1] === "italic"
                ? "italic " + font
                : font;
            this._context.font =
              themeProperties.length === 2 && themeProperties[1] === "bold"
                ? "bold " + font
                : font;
            var y = Math.floor(fontSize.height * 0.8) + paddingTop;
            for (
              var line = this._scrollPosition.line;
              line < this._scrollPosition.line + size.line;
              line++
            ) {
              if (line < this._textBuffer.getLines()) {
                ...
                while (position < text.length) {
                  ...
                  var length_1 =
                    index < syntax.length
                      ? syntax[index].start - position
                      : text.length - position;
                  var part = "";
                  for (var n = position; n < position + length_1; n++) {
                    part +=
                      text[n] !== "\t" ? text[n] : this._textModel.tabText;
                  }
                  if (
                    currentStyle === style &&
                    column - this._scrollPosition.column + part.length > 0 &&
                    column - this._scrollPosition.column < size.column
                  ) {
                    this._context.fillText(
                      part,
                      (column - this._scrollPosition.column) * fontSize.width +
                        paddingLeft,
                      y
                    );
                  }
    ...
    TextEditor.prototype.invalidateSelection = function (textRange) {
      ...
      var paddingTop = parseFloat(this._theme.paddingTop);
      var fontSize = this.fontSize;
      var rectangle = new Textor.Rectangle(
        0,
        (textRange.end.line - this._scrollPosition.line) * fontSize.height +
          paddingTop,
        this._canvas.width,
        fontSize.height
      );
    ...
    TextEditor.prototype.onSelectionChanged = function (e) {
      for (
        var _i = 0, _a = this._selectionChangedHandlers;
        _i < _a.length;
        _i++
      ) {
        var handler = _a[_i];
...
(function (Textor) {
  var TextModel = /** @class */ (function () {
    function TextModel(undoService, textBuffer) {
      this._textRange = new Textor.TextRange(
        new Textor.TextPosition(0, 0),
        new Textor.TextPosition(0, 0)
      );
      this._selectionChangedHandlers = [];
    ...
    TextModel.prototype.select = function (textPosition) {
      if (
        !textPosition.equals(this._textRange.start) ||
        !textPosition.equals(this._textRange.end)
      ) {
        var oldRange = this._textRange;
        this._textRange = new Textor.TextRange(
          new Textor.TextPosition(textPosition.line, textPosition.column),
          new Textor.TextPosition(textPosition.line, textPosition.column)
        );
        this.onSelectionChanged(
          new Textor.SelectionChangeEvent(oldRange, this._textRange)
        );
      }
    };
    TextModel.prototype.selectRange = function (textRange) {
      if (
        !textRange.start.equals(this._textRange.start) ||
        !textRange.end.equals(this._textRange.end)
      ) {
        var oldRange = this._textRange;
    ...
    TextModel.prototype.moveCursor = function (
      dimension,
      distance,
      direction,
      select
      ...
      if (!select) {
        position =
          direction === "previous"
            ? this.getTextRange().start
            : this.getTextRange().end;
        if (dimension === "line") {
          position.column =
            direction === "previous"
              ? this._textRange.start.column
              : this._textRange.end.column;
        }
      }
        ...
        if (select || this.isCursor()) {
          if (distance === "boundary") {
            ...
            if (direction !== "previous" && position.column >= text.length) {
              ...
              position.column = this.findWordBreak(
                text,
                position.column,
            ...
            position.column +=
              direction === "previous" ? -Number(distance) : +Number(distance);
          }
    ...
    TextModel.prototype.insertText = function (text) {
      ...
      this._undoService.add(
        new Textor.TextUndoUnit(
          this,
          this._textBuffer,
          this.toBufferRange(this.getTextRange()),
          text
        )
      );
      this._undoService.commit();
    ...
    TextModel.prototype.deleteSelection = function (position) {
      if (!this.isCursor() || position === null) {
        ...
        if (position === "previous") {
          ...
          if (textRange.start.column < 0) {
            ...
            if (textRange.start.line < 0) {
              ...
              textRange.start.column = this._textBuffer.getColumns(
                textRange.start.line
              );
            }
          }
        ...
        this._undoService.begin();
        this._undoService.add(
          new Textor.TextUndoUnit(this, this._textBuffer, textRange, "")
        );
        this._undoService.commit();
      }
    };
    TextModel.prototype.getTextRange = function () {
      ...
      if (textRange.start.column > this.getColumns(textRange.start.line)) {
        textRange.start = new Textor.TextPosition(
          textRange.start.line,
          this.getColumns(textRange.start.line)
        );
      }
      if (textRange.end.column > this.getColumns(textRange.end.line)) {
        textRange.end = new Textor.TextPosition(
          textRange.end.line,
          this.getColumns(textRange.end.line)
        );
      }
    ...
    TextModel.prototype.toScreenPosition = function (textPosition) {
      ...
      var text = this._textBuffer
        .getLine(textPosition.line)
        .substring(0, textPosition.column);
      var length = this.getTabLength(text) - text.length;
      return new Textor.TextPosition(
        textPosition.line,
    ...
    TextModel.prototype.toScreenRange = function (textRange) {
      return new Textor.TextRange(
        this.toScreenPosition(textRange.start),
        this.toScreenPosition(textRange.end)
      );
    };
    TextModel.prototype.toBufferRange = function (textRange) {
      return new Textor.TextRange(
        this.toBufferPosition(textRange.start),
        this.toBufferPosition(textRange.end)
      );
    };
  ...
  var TextRange = /** @class */ (function () {
    ...
    TextRange.prototype.normalize = function () {
      return this.start.compareTo(this.end) > 0
        ? new TextRange(this.end.clone(), this.start.clone())
        : this.clone();
    };
  ...
  var TextReader = /** @class */ (function () {
    ...
    TextReader.prototype.read = function () {
      if (this._textPosition.line < this._textBuffer.getLines()) {
        var text = this._textBuffer.getLine(this._textPosition.line);
        var c =
          this._textPosition.column >= text.length
            ? "\n"
            : text[this._textPosition.column];
...
(function (Textor) {
  var TextUndoUnit = /** @class */ (function () {
    ...
    TextUndoUnit.prototype.toString = function () {
      return (
        "Text: " +
        this._undoRange.toString() +
        " => " +
        this._redoRange.toString() +
        " | '" +
        this._undoText.replace(/\t/g, "\\t") +
        "' => '" +
        this._redoText.replace(/\t/g, "\\t") +
        "' | " +
        this._undoSelection.toString() +
        " => " +
        this._redoSelection.toString()
      );
    };
    return TextUndoUnit;
  })();
...
(function (Textor) {
  var ThemeManager = /** @class */ (function () {
    function ThemeManager() {
      ...
      this.add("peacock", {
        attributeStyle: "#AAAAAA bold",
        backgroundBlurColor: "#0b0a07",
        backgroundColor: "#1b1a17",
        commentStyle: "#7a7267 italic",
        cursorBackgroundColor: "#222222",
        cursorColor: "#FFFFFF",
        declarationStyle: "#FFFFFF italic",
        elementStyle: "#CCCCCC bold",
        errorStyle: "#AA0000 bold",
        fontFamily: "Menlo,Consolas,Courier New",
        fontSize: "13",
        keywordStyle: "#26A6A6 bold",
        literalStyle: "#bcd42a",
        paddingLeft: "20",
        paddingTop: "20",
        punctuationStyle: "#ede0ce",
        selectionBlurColor: "#282828",
        selectionColor: "#383838",
        textStyle: "#ede0ce",
      });
    ...
    UndoService.prototype.commit = function () {
      if (!this._container.isEmpty) {
        ...
        if (this._stack.length > 1) {
          ...
          if (
            c1.undoUnits.length === 1 &&
            c2.undoUnits.length > 0 &&
